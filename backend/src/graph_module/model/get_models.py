...
def get_embeddings_model():
    model = DashScopeEmbeddings(
        model='text-embedding-v2', # 直接填入模型名称
        dashscope_api_key='sk-a6ce27e9494e4bf8b326e3369aa1b063', # 直接填入你的真实阿里云API Key
        # dashscope_api_base='https://dashscope.aliyuncs.com/api/v1', # 如果需要，也可以直接填入Base URL
    )
    return model
